...
public class MindthiefDeck {
    ...
    AbilityCard card3 = new AbilityCard(1, 1, 3);
    AbilityCard card4 = new AbilityCard(3, 2, 1);
    AbilityCard card5 = new AbilityCard(3, 1, 1);
    AbilityCard card6 = new AbilityCard(2, 2, 2);
    AbilityCard card7 = new AbilityCard(6, 1, 0);
